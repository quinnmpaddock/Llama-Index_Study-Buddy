...
class Neo4jConfig:
    ...
    def __init__(self, config_dict: dict):
        ...
        if "NEO4J_PASSWORD" not in os.environ and config_dict.get("password"):
            logger.warning(
                "Neo4j password loaded from config file. "
                "Set NEO4J_PASSWORD environment variable for better security."
            )
