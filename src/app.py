...
from core_classes import GraphRAGQueryEngine, GraphRAGStore, GraphQueryResponse
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        if not os.path.exists(SUMMARIES_PATH):
            logger.error(f"Summaries file not found at {SUMMARIES_PATH}. Please run main.py first.")
